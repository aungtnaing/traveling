<div class="col_full bottommargin-lg clearfix">
	<div class="fancy-title title-border">
	    <a href="{{ url('/travelsectorupdates') }}"><h3>Travel Sector Updates</h3></a>
	...
	<div class="ipost clearfix">
		...
		<div class="col_half bottommargin-sm col_last">
			<div class="entry-title">
				<h3><a href="{{ url('/travelsectorupdates', $travelsectorposts[0]->name) }}">{{ $travelsectorposts[0]->name }}</a></h3>
			</div>
			<ul class="entry-meta clearfix">
				<li><i class="icon-calendar3"></i>{{ $travelsectorposts[0]->created_at }}</li>
				<li><a href="{{ url('/travelsectorupdates', $travelsectorposts[0]->name) }}"><i class="icon-comments"></i>{{ $tcmt }}</a></li>
	...
	<div class="col_half nobottommargin">
		...
		<div class="spost clearfix">
			...
			<div class="entry-c">
				<div class="entry-title">
					<h4><a href="{{ url('/travelsectorupdates', $travelsectorposts[1]->name) }}">{{ $travelsectorposts[1]->name }}</a></h4>
				</div>
				<ul class="entry-meta">
					<li><i class="icon-calendar3"></i>{{ $travelsectorposts[1]->created_at }}</li>
					<li><a href="{{ url('/travelsectorupdates', $travelsectorposts[1]->name) }}"><i class="icon-comments"></i> {{ $tcmt }}</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="spost clearfix">
			...
			<div class="entry-c">
				<div class="entry-title">
					<h4><a href="{{ url('/travelsectorupdates', $travelsectorposts[2]->name) }}">{{ $travelsectorposts[2]->name }}</a></h4>
				</div>
				<ul class="entry-meta">
					<li><i class="icon-calendar3"></i>{{ $travelsectorposts[2]->created_at }}</li>
					<li><a href="{{ url('/travelsectorupdates', $travelsectorposts[2]->name) }}"><i class="icon-comments"></i> {{ $tcmt }}</a></li>
				</ul>
			</div>
		</div>
	...
	<div class="col_half nobottommargin col_last">
		...
		<div class="spost clearfix">
			...
			<div class="entry-c">
				<div class="entry-title">
					<h4><a href="{{ url('/travelsectorupdates', $travelsectorposts[3]->name) }}">{{ $travelsectorposts[3]->name }}</a></h4>
				</div>
				<ul class="entry-meta">
					<li><i class="icon-calendar3"></i>{{ $travelsectorposts[3]->created_at }}</li>
					<li><a href="{{ url('/travelsectorupdates', $travelsectorposts[3]->name) }}"><i class="icon-comments"></i> {{ $tcmt }}</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="spost clearfix">
			...
			<div class="entry-c">
				<div class="entry-title">
					<h4><a href="{{ url('/travelsectorupdates', $travelsectorposts[4]->name) }}">{{ $travelsectorposts[4]->name }}</a></h4>
				</div>
				<ul class="entry-meta">
					<li><i class="icon-calendar3"></i>{{ $travelsectorposts[4]->created_at }}</li>
					<li><a href="{{ url('/travelsectorupdates', $travelsectorposts[4]->name) }}"><i class="icon-comments"></i> {{ $tcmt }}</a></li>
				</ul>
			</div>
		</div>
