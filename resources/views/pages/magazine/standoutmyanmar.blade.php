	...
	<div class="fancy-title title-border">
				<a href="{{ url('mn/standout') }}"><h3>Standout</h3></a>
	...
	<div class="col_one_third">
		<div class="ipost clearfix">
			...
			<div class="entry-title">
				<h3><a href="{{ url('/mn/standout', $standout->mname) }}">{{ $standout->mname }}</a></h3>
			</div>
			<ul class="entry-meta clearfix">
				<li><i class="icon-calendar3"></i>{{ $standout->created_at }}</li>
				<li><a href="{{ url('/mn/standout', $standout->mname) }}"><i class="icon-comments"></i>{{ $tcmt }}</a></li>
			</ul>
