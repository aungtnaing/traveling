<div class="col_full nobottommargin clearfix">
	...
	<div class="fancy-title title-border">
		<a href="{{ url('mn/departures') }}"><h3>Departures</h3></a>
	</div>
	...
	<div class="col_one_third">
		<div class="ipost clearfix">
			...
			<div class="entry-title">
				<h3><a href="{{ url('/mn/deperature', $deperature->mname) }}">{{ $deperature->mname }}</a></h3>
			</div>
			<ul class="entry-meta clearfix">
				<li><i class="icon-calendar3"></i>{{ $deperature->created_at }}</li>
				<li><a href="{{ url('/mn/deperature', $deperature->mname) }}"><i class="icon-comments"></i>{{ $tcmt }}</a></li>
			</ul>
