							...
							<div class="flexslider">
								<div class="slider-wrap">
									<div class="slide" data-thumb="{{ $postdetail->photourl1 }}">
										<a href="{{ url('/picturesques', $postdetail->name) }}">
											<img src="{{ $postdetail->photourl2 }}" alt="">
											<div class="overlay">
												<div class="text-overlay">
													<div class="text-overlay-title">
														<a href="{{ url('/picturesques', $postdetail->name) }}"><h3>{{ $postdetail->groupname }}</h3></a>
													</div>
									...
									<div class="slide" data-thumb="{{ $grouppost->photourl1 }}">
										<a href="{{ url('/picturesques', $grouppost->name) }}">
											<img src="{{ $grouppost->photourl2 }}" alt="">
											<div class="overlay">
												<div class="text-overlay">
													<div class="text-overlay-title">
														<a href="{{ url('/picturesques', $grouppost->name) }}"><h3>{{ $postdetail->groupname }}</h3></a>
													</div>
													<div class="text-overlay-meta">
