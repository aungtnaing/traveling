				...
				<div class="container clearfix">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<a href="{{ url('/checkoutsmyanmar') }}">​ငွေရှင်းရန်   :   </a><label id='totalbox'></label>ks.
							</div>
						</div>
					</div>
					<!-- Post Content
							...
							<div class="product {{ $book->volnumber }} clearfix">
								<div class="product-image">
									...
									<div class="product-overlay">
										<a href="javascript:addbook({{ $book->price }}, {{ $book->volnumber }}, {{ $book->issuenumber }}, {{ $book->id }})" class="add-to-cart"><i class="icon-shopping-cart"></i><span>ဝယ်ယူရန်</span></a>
