					...
					<a href="{{ url('/specialsupplement') }}"><h4>Special Supplement</h4></a>
						...
						<div class="spost clearfix">
							<div class="entry-image">
								...
								<a href="{{ $supplement->photourl1 }}" class="nobg"><img class="" src="{{ $supplement->photourl2 }}" alt=""></a>
							</div>
							<div class="entry-c">
								<div class="entry-title">
									<h4><a href="{{ url('/specialsupplement', $supplement->name) }}">{{ $supplement->name }}</a></h4>
								</div>
								<ul class="entry-meta">
									<li>{{ $supplement->created_at }}</li>
								</ul>
							</div>
						</div>
