...
<div id="content">
 ...
 <div class="control-group">
              <label class="control-label">Group Name : ျမန္မာ</label>
              <div class="controls">
                <input name="mgroupname" class="span11" value="{{ $post->mgroupname }}" placeholder="Enter Your Group Name(ျမန္မာ)" type="text">
              </div>
            </div>


             <div class="control-group">
              <label class="control-label">Post Name : Zawgyi</label>
              <div class="controls">
                <input name="zname" class="span11" value="{{ $post->zname }}" placeholder="Enter Your Post Name(Zawgyi)" type="text" required>
              </div>
            </div>
  ...
  <div class="control-group">
              <label class="control-label">Content : Zawgyi</label>
              <div class="controls">
              <textarea class="textarea_editor span12" name="zdescription" placeholder="Enter your post content(Zawgyi)" class="span11" rows="7">{{ $post->zdescription }}</textarea>
