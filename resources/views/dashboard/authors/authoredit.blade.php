...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">edit author</a> </div>
        ...
        <div class="widget-box">
          ...
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <li class="span3"> <a> 
                  ...
                  <label for="file-input1">
                    <i class="icon-camera"></i>.Photo 120 X 120<br>
                     @if($author->photourl!="")
                    <img id="blah" src= "{{ $author->photourl }}" width="100" height="100">
                    @else
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input name="name" class="span11" placeholder="Enter author name" type="text" value="{{ $author->name }}" required>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input name="email" class="span11" placeholder="Enter author email" value="{{ $author->email }}" type="text">
                </div>
              </div>
               ...
               <div class="control-group">
                ...
                <div class="controls">
                  <input name="phone" class="span11" placeholder="Enter author phone" type="text" value="{{ $author->phone }}">
                </div>
              </div>
              ...
              <label class="control-label">Bio :</label>
                <div class="controls">
                  <textarea class="textarea_editor span12" name="bio" placeholder="Enter author bio" class="span11" rows="2">{{ $author->bio }}"</textarea>
