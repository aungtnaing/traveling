...
<head>
  ...
  <head>
    ...
    <meta property="og:title"         content="{{ $postdetail->zname }}" />
    <meta property="og:description"   content="{{ $zbody }}" />
    <meta property="og:image"         content="<?php echo url(); ?>{{ $postdetail->photourl1 }}" />
    <meta property="fb:app_id" content="146821059241551" />


    <title>{{ $postdetail->zname }}</title>
    <meta name="description" content="{{ $zbody }}">
